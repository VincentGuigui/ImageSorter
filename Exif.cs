...
namespace ImageSorter
{
	...
	public class EXIF
	{
		...
		public enum KnownEXIFIDCodes
		{
			...
			Software = 0x0131, 
			/// <summary>
			/// Date/Time of image was last modified. Data format is "YYYY:MM:DD HH:MM:SS"+0x00, 
			/// total 20bytes. If clock has not set or digicam doesn't		
			/// have clock, the field may be filled with spaces. 
		...
		public class EXIFPropertyItem
		{
			...
			public EXIFPropertyItem(System.Drawing.Imaging.PropertyItem prop)
			{
